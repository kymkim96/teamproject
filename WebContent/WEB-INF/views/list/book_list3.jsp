...
<body>
		...
		<header>
			...
			<ul id="headerul2">
				...
				<button class="btn btn-sm"><a href="../../view/list/book_list2.html">자기개발서</a></button>
				<button class="btn btn-sm"><a href="book_list3.html">해외소설</a></button>
		...
		<section>
			...
			<div id="item">
				...
				<a id="book_img" href="../../view/detail/13.html">
					<img src="../../resources/img/foreign1.jpg"></a>
			...
			<div id="item">
				...
				<img src="../../resources/img/foreign2.jpg"></a>
			...
			<div id="item">
				...
				<img src="../../resources/img/foreign3.jpg"></a>
			...
			<div id="item">
				<a id="book_img" href="">
				<img src="../../resources/img/foreign4.jpg"></a>
			...
			<div id="item">
				<a id="book_img" href="">
				<img src="../../resources/img/foreign5.jpg"></a>
			...
			<div id="item">
				<a id="book_img" href="">
				<img src="../../resources/img/foreign6.jpg"></a>
			...
			<div id="item">
				...
				<a id="book_img" href="">
				<img src="../../resources/img/foreign7.jpg"></a>
			...
			<div id="item">
				...
				<a id="book_img" href="">
				<img src="../../resources/img/foreign8.jpg"></a>
			...
			<div id="item">
				...
				<a id="book_img" href="">
				<img src="../../resources/img/foreign9.jpg"></a>
			...
			<div id="item">
				<a id="book_img" href="">
				<img src="../../resources/img/foreign10.jpg"></a>
			...
			<ul class="headerul2">
				...
				<button class="btn btn-sm ">광고안내</button>
				<button class="btn btn-sm ">SCM</button>
