		...
		<div id="item1">
				...
				<div id ="book_data" >
					<ul id="data">
						...
						<span class="price2">10,800원 (10%↓+5%P)</span></h3></li>
						<li>2010년 박범신의 신작 장편소설 『은교』 “이 소설로 나는 내 안의 욕망이라는 게 여전히<br />
							눈물겹게 불타고 있음을 알았다!” (박범신) “연애소설이 예술가소설로 육박한 사례라고 하...</li>
					</ul>
				</div>
         ...
         <div id="item1">
            ...
            <div id="book_data">
               <ul id="data">
                  ...
                  <li>“사람들이 나보고 맘충이래.”한국에서 여자로 살아가는 일그 공포, 피로, 당황, 놀람, 혼란,<br />
              		    좌절의  연속에 대한 인생 현장 보고서 조남주 장편소설 『82년생 김지영』이 민음사 ‘오...   </li> 
               </ul>
            </div>
            ...
            <div id="book_data">
               <ul id="data">
                  ...
                  <li>“무서운 건 악이 아니오. 시간이지. 아무도 그걸 이길 수가 없거든.” 남성적인 문체의 속도에<br />
                     대한 완벽한 배반, 시야가 좁아질 정도의 질주를 스키드 마크도 없이 일시에 끝내버린 ... </li>
               </ul>
            </div>
         ...
         <div id="item1">
            ...
            <div id="book_data">
               <ul id="data">
                  ...
                  <li>
                  <li>“네 사랑이 무사하기를, 내 사랑도 무사하니까”20만 독자들에게 친구가 되어준, 늘 곁에 두고 싶은이야기■<br /> 
                  	    작품 소개‘다시 한 번 사랑해보기로 한’ 모든 이를 향한 따뜻한 시선 ...
                  </li>  
               </ul>
            </div>
