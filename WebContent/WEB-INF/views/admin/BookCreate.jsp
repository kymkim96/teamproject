		...
		<div id="layout">
			...
			<div class="content">
		        ...
		        <div class="content">
		                ...
		                <div id="basic_first">
		                    ...
		                    <div id="basic_first_image">
		                        ...
		                        <div id="basic_first_image_thumbnail">
		                            <img width="300px" src="<%=application.getContextPath()%>/resources/img/미리보기.jpg" class="img-thumbnail" alt="미리보기">
		                        </div>
		                    </div>
		                </div>
		                <div id="basic_second">
		            ...
		            <div id="category_layout">
		                ...
		                <div id="category_first">
		                    ...
		                    <ul id="category_first_right">
		                        <li>
		                            <div class="form-group">
		                                <input readonly class="form-control" id="category_select">
		                            </div>
		                        </li>
		                        <li>
		                            <div class="form-group">
		            ...
		            <div id="finish_line">
		                <button type="button" id="btn-submit" class="btn btn-outline-secondary btn-lg">등록</button>
		            </div>
		        </div>
			</div>
